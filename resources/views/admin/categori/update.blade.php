...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800"> Modifiez la categori</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="user" method="POST" action="{{ route('admin.categori.update') }}">
                @csrf
                <div class="form-group">
                    <label class="text-gray-800 ont-weight-bold" > Nom </label>
                    <input type="text" name="name" class="form-control form-control-user" value="{{$categori->name}}">
                </div>
                <div class="form-group">
                    <label class="text-gray-800 ont-weight-bol" name="description"> Description </label>
                    <textarea type="text" name="description" class="form-control form-control-user">{{$categori->description}}</textarea>
                </div>
